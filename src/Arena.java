...
public class Arena {
    ...
    private void chooseTeamWarriors(List<Warrior> warriors, String teamName, int teamBudget) {
        while (teamBudget >= 10000) {
            ...
            System.out.println();
            System.out.println("0 <- Peasant, cost: 10 000");
            System.out.println("1 <- Knight, cost 25 000");
            System.out.println("2 <- Paladin, cost 60 000");
            Scanner scanner = new Scanner(System.in);
            ...
            switch (choice) {
                case WarriorType.Peasant:
                    ...
                    if (teamBudget >= peasant.getCost()) {
                        teamBudget -= peasant.getCost();
                        warriors.add(peasant);
                ...
                case WarriorType.PALADIN:
                    ...
                    if (teamBudget >= paladin.getCost()) {
                        teamBudget -= paladin.getCost();
